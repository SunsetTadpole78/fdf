...
/*   Updated: 2025/02/12 22:57:40 by lroussel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

static void	init_keys(t_fdf *fdf)
{
	init_controls(&fdf->conic.controls);
...
static void	init_default_z(t_fdf *fdf)
{
	...
	while ((is_outside(conic_data(fdf, p1, 0).pos)
			|| is_outside(conic_data(fdf, p2, 0).pos)
			|| is_outside(conic_data(fdf, p3, 0).pos))
